...
<li>LINEAS_A_ELIMINAR: es la cantidad de líneas a purgar del texto de prueba, puesto que el texto elegido tiene una introducción insertada por el sitio de donde se sacaron los textos.</li>
